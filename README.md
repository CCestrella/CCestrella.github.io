...
- [ ] Uses semantic HTML:  I utilized semantic HTML tags such as header, section, class and id. This practice improves the website’s accessibility as it provides meaningful structure and context to the content, making it easier for search engines and assistive technologies to interpret and navigate.
